# Airbrush Painter - Containerized GPU environment
#
...
#              airbrush_painter:latest python scripts/demo_alcohol_ink.py
#
# Run tests:
#   docker run --gpus all airbrush_painter:latest python -m pytest tests/ -v
...
LABEL description="Robotic airbrush painting system"
LABEL version="3.0.0"
