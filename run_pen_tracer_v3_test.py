#!/usr/bin/env python3
"""Test pen tracer V3 - gamut-aware with HD resolution."""
...
from src.data_pipeline import pen_tracer_v3
from src.utils import logging_config

# Setup logging
Path("outputs/logs").mkdir(parents=True, exist_ok=True)
logging_config.setup_logging(log_level="INFO", log_file="outputs/logs/pen_test_v3.log")
...
out_dir = "outputs/pen_test_v3"

print("="*80)
print("PEN TRACER V3 TEST - A4 Print Quality")
print("="*80)
print(f"\nInput: {image_path}")
...
try:
    result = pen_tracer_v3.make_pen_layer_v3(
